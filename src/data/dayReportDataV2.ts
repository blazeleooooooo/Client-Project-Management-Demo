...
export const staffMembersV2: (StaffMemberV2 & { __sampleData: true })[] = [
  // System Department
  { __sampleData: true, id: 'u1', name: 'Jordan Lee', role: 'super_admin', department: 'System', position: '系統管理員' },
  { __sampleData: true, id: 'u2', name: 'Sam Chen', role: 'project_manager', department: 'System', position: '項目經理' },
  { __sampleData: true, id: 'u3', name: 'Riley Park', role: 'designer', department: 'System', position: '資深設計師' },
  // FC Department
...
export const dailyReportsV2: (DailyReportV2 & { __sampleData: true })[] = [
  {
    ...
    entries: [
      { id: 'we1', dailyReportId: 'dr1', category: 'website_design', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: '首頁改版設計', description: '完成首頁 Hero Section 重新設計，包含動態輪播與 CTA 按鈕優化', hours: 3.5, outcomeType: 'url', outcomeUrl: 'https://staging.example.com/homepage-v2', growthExperience: '學到了更好的視覺層次安排方法', isAiAssisted: true, aiTools: ['midjourney'], createdAt: '2025-01-20T10:00:00' },
      { id: 'we2', dailyReportId: 'dr1', category: 'article_writing', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'SEO 文章撰寫', description: '完成「2025年網頁設計趨勢」文章 2000字，優化關鍵字密度', hours: 2.5, outcomeType: 'url', outcomeUrl: 'https://example.com/blog/web-design-trends-2025', growthExperience: '利用 ChatGPT 加快大綱撰寫速度 3 倍', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-20T14:00:00' },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'we10', dailyReportId: 'dr3', category: 'video_shooting', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 企業影片', description: '拍攝 BW 辦公室環境及團隊介紹片段', hours: 3.0, outcomeType: 'image', outcomeImages: ['https://drive.google.com/bw-video-raw-jan20'], isAiAssisted: false, createdAt: '2025-01-20T15:00:00' },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'we13', dailyReportId: 'dr4', category: 'website_dev', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 網站 Bug 修復', description: '修復手機版選單切換動畫卡頓問題', hours: 2.0, outcomeType: 'url', outcomeUrl: 'https://github.com/bw-design/pull/45', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-20T14:00:00' },
  ...
  },
  {
    ...
    submittedAt: '2025-01-20T18:30:00',
    entries: [
      { id: 'we15', dailyReportId: 'dr6', category: 'article_writing', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 部落格文章', description: '撰寫「如何選擇企業網站設計公司」SEO 文章 1800字', hours: 3.5, outcomeType: 'url', outcomeUrl: 'https://docs.google.com/doc/bw-blog-jan20', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-20T10:00:00' },
  ...
  },
  {
    ...
    entries: [
      { id: 'we18', dailyReportId: 'dr7', category: 'paid_ads', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW Google Ads 優化', description: '調整 Google Ads 出價策略及廣告文案 A/B 測試', hours: 3.0, outcomeType: 'url', outcomeUrl: 'https://ads.google.com/campaigns/bw-jan', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-20T10:00:00' },
  ...
  // System Department Reports (2025-01-20)
  {
    ...
    entries: [
      { id: 'we40', dailyReportId: 'dr14', category: 'website_dev', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: '系統架構設計', description: '完成新版日報系統的部門篩選架構及 RLS 策略設計', hours: 4.0, outcomeType: 'url', outcomeUrl: 'https://github.com/bw-system/pull/89', isAiAssisted: true, aiTools: ['cursor'], createdAt: '2025-01-20T10:00:00' },
      ...
      { id: 'we42', dailyReportId: 'dr14', category: 'website_dev', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'API 權限模組開發', description: '完成 Edge Function 權限中間件及部門過濾邏輯', hours: 3.5, outcomeType: 'url', outcomeUrl: 'https://github.com/bw-system/pull/90', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-20T16:00:00' },
    ],
  },
  {
    __sampleData: true,
  ...
  },
  {
    ...
    submittedAt: '2025-01-20T18:00:00',
    entries: [
      { id: 'we46', dailyReportId: 'dr16', category: 'website_design', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 產品頁面設計', description: '完成產品展示頁面 UI 設計及動效原型', hours: 4.0, outcomeType: 'url', outcomeUrl: 'https://figma.com/bw-products-v2', isAiAssisted: true, aiTools: ['midjourney'], createdAt: '2025-01-20T10:00:00' },
  ...
  // Previous day
  {
    ...
    entries: [
      { id: 'we22', dailyReportId: 'dr8', category: 'website_design', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 服務頁面設計', description: '完成服務頁面整體版面設計及互動原型', hours: 4.0, outcomeType: 'url', outcomeUrl: 'https://figma.com/bw-services-v3', isAiAssisted: true, aiTools: ['midjourney'], createdAt: '2025-01-17T10:00:00' },
  ...
  },
  {
    ...
    entries: [
      { id: 'we28', dailyReportId: 'dr10', category: 'website_design', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 關於我們頁面', description: '完成公司介紹頁面內容更新', hours: 2.5, outcomeType: 'url', outcomeUrl: 'https://staging.example.com/about', isAiAssisted: false, createdAt: '2025-01-16T09:00:00' },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'we32', dailyReportId: 'dr11', category: 'video_shooting', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 短視頻拍攝', description: '拍攝 BW 服務介紹 30 秒短視頻 x3', hours: 2.0, outcomeType: 'image', outcomeImages: ['https://drive.google.com/bw-shorts-jan17'], isAiAssisted: false, createdAt: '2025-01-17T16:00:00' },
    ],
  },
  {
    __sampleData: true,
    ...
    submittedAt: '2025-01-17T18:00:00',
    entries: [
      { id: 'we33', dailyReportId: 'dr12', category: 'article_writing', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 文章撰寫', description: '撰寫「響應式設計最佳實踐」文章', hours: 4.0, outcomeType: 'url', outcomeUrl: 'https://docs.google.com/doc/bw-rwd-article', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-17T10:00:00' },
  ...
  },
  {
    ...
    entries: [
      { id: 'we36', dailyReportId: 'dr13', category: 'paid_ads', relatedType: 'website', relatedId: 'ws1', relatedName: 'Acme Site', title: 'BW 廣告投放優化', description: '調整廣告受眾及出價策略', hours: 3.0, outcomeType: 'url', outcomeUrl: 'https://ads.google.com/bw-optimize', isAiAssisted: true, aiTools: ['chatgpt'], createdAt: '2025-01-17T10:00:00' },
